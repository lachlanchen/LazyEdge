...
| `spec.transport` | yes | outbound-created transport; v0.4 preview supports `openssh-reverse` |
...
| Field | Meaning |
| --- | --- |
| `provider` | exactly `openssh-reverse` in the v0.4 preview |
